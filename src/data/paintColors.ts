...
export const paintColors: PaintColor[] = [
  // Whites & Beiges
  { id: "DJdof5HCboh6dSKLpjvw", name: "Lunar White", hex: "#e7d6c2", type: "glossy", group: "whites-beiges", alexSealColorNo: "9107", index: 0 },
  { id: "zjmquxx74A2ti0H5E2Go", name: "Matterhorn White", hex: "#dde0e1", type: "glossy", group: "whites-beiges", alexSealColorNo: "9123", index: 1 },
  { id: "6odSz64DXk2bV898HRs9", name: "Fleet White", hex: "#e7e4dd", type: "glossy", group: "whites-beiges", alexSealColorNo: "9126", index: 2 },
  { id: "nJJtaBpB1vvgk0czotNO", name: "Off White", hex: "#eae8e1", type: "glossy", group: "whites-beiges", alexSealColorNo: "9130", index: 3 },
  { id: "7lAfDcC1KyHZKk133pTV", name: "Cloud White", hex: "#efedec", type: "glossy", group: "whites-beiges", alexSealColorNo: "9132", index: 4 },
  { id: "UNx2Z39X4JKIRcSaEcma", name: "Snow White", hex: "#ececeb", type: "glossy", group: "whites-beiges", alexSealColorNo: "9134", index: 5 },
  { id: "fmZOnsyqqvZrkpKfPGRH", name: "Arctic White", hex: "#deded8", type: "glossy", group: "whites-beiges", alexSealColorNo: "9135", index: 6 },
  { id: "PWg5lXZaZ6EdWDLLY2rC", name: "Eggshell White", hex: "#e7ded0", type: "glossy", group: "whites-beiges", alexSealColorNo: "9138", index: 7 },
  { id: "Wjbrx0HRIYNg2pKuRhCT", name: "Montblanc White", hex: "#e2e4e0", type: "glossy", group: "whites-beiges", alexSealColorNo: "9145", index: 8 },
  { id: "gPzs47QhawFERtDXaGDB", name: "Carina White", hex: "#dddedd", type: "glossy", group: "whites-beiges", alexSealColorNo: "9146", index: 9 },
  { id: "oD2ckIbQ3BvSds6RfNu2", name: "Vanilla White", hex: "#efe8d4", type: "glossy", group: "whites-beiges", alexSealColorNo: "9147", index: 10 },
  { id: "BvFDkHJjnKFhN3QJ57g8", name: "Nordic White", hex: "#e0ddc9", type: "glossy", group: "whites-beiges", alexSealColorNo: "9148", index: 11 },
  { id: "VPbM9RFTlYGJYWn9kO01", name: "Cream", hex: "#eedfc9", type: "glossy", group: "whites-beiges", alexSealColorNo: "1150", index: 12 },
  { id: "PFWmileHgaHwqeyS8prE", name: "Light Ivory", hex: "#e7d4c9", type: "glossy", group: "whites-beiges", alexSealColorNo: "1183", index: 13 },
  ...
  // Golds & Browns
  { id: "afieKWIhaiHq5tdNYhyJ", name: "Eagle Brown", hex: "#5c4f4b", type: "glossy", group: "golds-browns", alexSealColorNo: "8127", index: 14 },
  { id: "qXmLRZpxXZRmtOgYIftF", name: "Buffalo Brown", hex: "#7e746e", type: "glossy", group: "golds-browns", alexSealColorNo: "8128", index: 15 },
  { id: "hFdyeFxOWdnXBVifJkZq", name: "Sahara Tan", hex: "#95765f", type: "glossy", group: "golds-browns", alexSealColorNo: "8160", index: 16 },
  { id: "nvN3deUK4dgplu9qyZzk", name: "Sable Brown", hex: "#43271e", type: "glossy", group: "golds-browns", alexSealColorNo: "8168", index: 17 },
  { id: "sOskF89lpiVNH9I3vjJY", name: "Horizons Teak", hex: "#5a3511", type: "glossy", group: "golds-browns", alexSealColorNo: "8191", index: 18 },
  { id: "SxPOYTmpRV8GbLhSsJhM", name: "Camel Beige", hex: "#b9a689", type: "glossy", group: "golds-browns", alexSealColorNo: "1151", index: 19 },
  { id: "xc0NnxkrrHCFqifcFbD3", name: "Savannah Beige", hex: "#cc9d6e", type: "glossy", group: "golds-browns", alexSealColorNo: "1152", index: 20 },
  { id: "MWRuH59qbCEY7ZTJRzfW", name: "Moon Dust", hex: "#d6c5ac", type: "glossy", group: "golds-browns", alexSealColorNo: "1158", index: 21 },
  { id: "P6GfW2gJjMVChHEZLYpJ", name: "San Mateo Wheat", hex: "#e5c799", type: "glossy", group: "golds-browns", alexSealColorNo: "1236", index: 22 },
  ...
  // Blacks & Greys
  { id: "1OCkutQTBVXQDCmV9W4Q", name: "Super Jet Black", hex: "#0b0706", type: "glossy", group: "blacks-greys", alexSealColorNo: "9232", index: 23 },
  { id: "TmdKFr7xPqZvPFBsfrNE", name: "Whisper Gray", hex: "#c1c7ca", type: "glossy", group: "blacks-greys", alexSealColorNo: "7151", index: 24 },
  { id: "mOFhTfTENRP1vDgRJMSf", name: "Pearl Gray", hex: "#c3c5c1", type: "glossy", group: "blacks-greys", alexSealColorNo: "7152", index: 25 },
  { id: "Lh0rtLq5ALFKJUTlOEQh", name: "Light Gray", hex: "#aeb0ae", type: "glossy", group: "blacks-greys", alexSealColorNo: "7153", index: 26 },
  { id: "7H4N5VjZEYDr0QKYybNX", name: "Pegasus Gray", hex: "#cac2b6", type: "glossy", group: "blacks-greys", alexSealColorNo: "7154", index: 27 },
  { id: "GQEDVzy9M3iZSuHx0Us0", name: "Kingston Gray", hex: "#a6afb3", type: "glossy", group: "blacks-greys", alexSealColorNo: "7155", index: 28 },
  { id: "gDZ6CNsN4NaLQsKqBPhY", name: "Dark Gray", hex: "#596d6f", type: "glossy", group: "blacks-greys", alexSealColorNo: "7156", index: 29 },
  { id: "YP9iKynRa82b26BC5hdd", name: "Raccoon Gray", hex: "#7c8181", type: "glossy", group: "blacks-greys", alexSealColorNo: "7188", index: 30 },
  { id: "BCkYLpmSB0n18P3AtL6s", name: "Warm Gray", hex: "#a19891", type: "glossy", group: "blacks-greys", alexSealColorNo: "7189", index: 31 },
  { id: "k6bPNUL7xsW8272irGZY", name: "Stingray Gray", hex: "#414748", type: "glossy", group: "blacks-greys", alexSealColorNo: "7190", index: 32 },
  { id: "USdY0S30MpxqWpMshZiq", name: "Seattle Gray", hex: "#c5cabb", type: "glossy", group: "blacks-greys", alexSealColorNo: "7281", index: 33 },
  { id: "6vfvTZcKHgbcRBVrQccn", name: "Thunderstorm Gray", hex: "#2c3437", type: "glossy", group: "blacks-greys", alexSealColorNo: "7389", index: 34 },
  { id: "ExnNRbVL1NxLnS7CnuKh", name: "Silver Metallic", hex: "#a4a7aa", type: "glossy", group: "blacks-greys", alexSealColorNo: "943", index: 76 },
  { id: "DOE9lpOToNOH72MaIK6P", name: "Storm Grey Metallic", hex: "#4c4743", type: "glossy", group: "blacks-greys", alexSealColorNo: "953", index: 77 },
  { id: "EDEGCOH0jY4QVWnPNIzf", name: "Dark Black Metallic", hex: "#30302e", type: "glossy", group: "blacks-greys", alexSealColorNo: "9449", index: 78 },
  ...
  // Blues
  { id: "jMcprYtHjIAjYINllSWv", name: "Sky Blue", hex: "#57a1bd", type: "glossy", group: "blues", alexSealColorNo: "5117", index: 35 },
  { id: "eskvwvE6Y014OMb4X4Rl", name: "Petrol Blue", hex: "#2c5b6c", type: "glossy", group: "blues", alexSealColorNo: "5133", index: 36 },
  { id: "vmvUN1N0xo5RhZkbP6nW", name: "Royal Blue", hex: "#003169", type: "glossy", group: "blues", alexSealColorNo: "5150", index: 37 },
  { id: "m6bIenxgFgtpPHfnRSAC", name: "Navy Blue", hex: "#00427e", type: "glossy", group: "blues", alexSealColorNo: "5151", index: 38 },
  { id: "kklCJ1E8xudjtSYJ6U1N", name: "Capri Blue", hex: "#006a98", type: "glossy", group: "blues", alexSealColorNo: "5152", index: 39 },
  { id: "9ZczzXZYtTE7oN4DgRjb", name: "Flag Blue", hex: "#0c1927", type: "glossy", group: "blues", alexSealColorNo: "5153", index: 40 },
  { id: "lHVvorrpP3shcav6UxcB", name: "Aristo Blue", hex: "#00284f", type: "glossy", group: "blues", alexSealColorNo: "5154", index: 41 },
  { id: "xpOAkYGcVFC1zPypARr7", name: "Majestic Blue", hex: "#08161f", type: "glossy", group: "blues", alexSealColorNo: "5158", index: 42 },
  { id: "NYpie3HEeOSBeTo6NNuW", name: "Ice Blue", hex: "#d1e5e9", type: "glossy", group: "blues", alexSealColorNo: "5159", index: 43 },
  { id: "Qp0WppUjxiN1kTyV4pnp", name: "Stars &amp; Stripes Blue", hex: "#3c667a", type: "glossy", group: "blues", alexSealColorNo: "5160", index: 44 },
  { id: "Gb7fjTxFXbQEozBb85Yj", name: "AD Blue", hex: "#22a9b6", type: "glossy", group: "blues", alexSealColorNo: "5179", index: 45 },
  { id: "nS1aeRpcF5YdMKg8anp9", name: "Etheral Blue", hex: "#c1dbe9", type: "glossy", group: "blues", alexSealColorNo: "5182", index: 46 },
  { id: "abPLIpSMrqZJ2NF9cIf4", name: "Fisherman Blue", hex: "#86b7c2", type: "glossy", group: "blues", alexSealColorNo: "5185", index: 47 },
  { id: "wtgLtR6PDiT4dQGUpVST", name: "Deep Sea Blue", hex: "#003b4e", type: "glossy", group: "blues", alexSealColorNo: "5192", index: 48 },
  { id: "7EaXzWmSOfLbrlBNfRe2", name: "Sorrento Blue", hex: "#10525e", type: "glossy", group: "blues", alexSealColorNo: "5193", index: 49 },
  { id: "KRzJmtul1u5qtUfmtu08", name: "Santorin Blue", hex: "#00274f", type: "glossy", group: "blues", alexSealColorNo: "5195", index: 50 },
  { id: "dnOurlscZ9XnoidKclvB", name: "Infinity Blue", hex: "#03203b", type: "glossy", group: "blues", alexSealColorNo: "5199", index: 51 },
  { id: "htiNFUblz2RYR2NWV3DM", name: "Midnight Blue", hex: "#111a28", type: "glossy", group: "blues", alexSealColorNo: "5200", index: 52 },
  { id: "nUCYi9vlpjgFxZwkEm9J", name: "Empress Blue", hex: "#0076a4", type: "glossy", group: "blues", alexSealColorNo: "5203", index: 53 },
  { id: "QiBDtS4qA4r9r9VChXVa", name: "Mint Blue", hex: "#a9d5e0", type: "glossy", group: "blues", alexSealColorNo: "5211", index: 54 },
  { id: "gKsmGpdDaDoVZ4HA71nk", name: "Lauderdale Blue", hex: "#005a8f", type: "glossy", group: "blues", alexSealColorNo: "5213", index: 55 },
  { id: "kU9PYr8obd2XsTi0mbTx", name: "Bimini Blue", hex: "#358aab", type: "glossy", group: "blues", alexSealColorNo: "5215", index: 56 },
  { id: "Q7rzwsdmp3wBFQYl4cyl", name: "Storm Blue", hex: "#678b9b", type: "glossy", group: "blues", alexSealColorNo: "5260", index: 57 },
  ...
  // Greens
  { id: "V5DpojdulfR6A7WH5qvN", name: "Jade Mist Green", hex: "#003321", type: "glossy", group: "greens", alexSealColorNo: "6150", index: 58 },
  { id: "XGD9bRmba1r3DVK3aaX4", name: "Forest Green", hex: "#00452f", type: "glossy", group: "greens", alexSealColorNo: "6152", index: 59 },
  { id: "bQCeLslhZYximLj0C1TF", name: "Dark Green", hex: "#031d19", type: "glossy", group: "greens", alexSealColorNo: "6155", index: 60 },
  { id: "tqm1LPr0L8L59cpQYpeM", name: "Aqua Mist", hex: "#d2e9e4", type: "glossy", group: "greens", alexSealColorNo: "6158", index: 61 },
  { id: "HUn1chlsRzK1SdZ00rss", name: "Sea Foam", hex: "#90dfd1", type: "glossy", group: "greens", alexSealColorNo: "6173", index: 62 },
  { id: "cX7JMDZEdAWSADym7m2w", name: "Sea Frost", hex: "#b5e4da", type: "glossy", group: "greens", alexSealColorNo: "6183", index: 63 },
  { id: "83rSVRAoPDs8jyXw9pt0", name: "Teal", hex: "#006568", type: "glossy", group: "greens", alexSealColorNo: "6188", index: 64 },
  { id: "AWIl3TKRzOLW5QxkC0WI", name: "Island Turquoise", hex: "#008988", type: "glossy", group: "greens", alexSealColorNo: "6216", index: 65 },
  { id: "7dCA0h5QCAEDcRUUWtUf", name: "Kelly Green", hex: "#005a17", type: "glossy", group: "greens", alexSealColorNo: "6219", index: 66 },
  ...
  { id: "0XmGCDg1dPGkuiSAyvk5", name: "Sea Owl Green", hex: "#134313", type: "glossy", group: "greens", alexSealColorNo: "6213", index: 143 },
  ...
  { id: "626ePy1VHni6OZ9uWNG7", name: "Sunfast Red", hex: "#a4000c", type: "glossy", group: "reds-oranges-yellows", alexSealColorNo: "3150", index: 67 },
  { id: "NHIhn6mk0I0AXyJAePpm", name: "Toreador Red", hex: "#a50e07", type: "glossy", group: "reds-oranges-yellows", alexSealColorNo: "3151", index: 68 },
  { id: "ApezciW6WPCq92qqDoSV", name: "Wine Red", hex: "#640f14", type: "glossy", group: "reds-oranges-yellows", alexSealColorNo: "3152", index: 69 },
  { id: "ZJ1VPZO1hBWeRq0Wm7gq", name: "Vivid Red", hex: "#880000", type: "glossy", group: "reds-oranges-yellows", alexSealColorNo: "3153", index: 70 },
  { id: "cBpWwHpcMzQGJUhPRZF4", name: "Blackberry Red", hex: "#512e3d", type: "glossy", group: "reds-oranges-yellows", alexSealColorNo: "3199", index: 71 },
  { id: "p3iit7yZRUT7LY8JR6Zx", name: "International Orange", hex: "#d63e00", type: "glossy", group: "reds-oranges-yellows", alexSealColorNo: "2165", index: 72 },
  { id: "FHfEubdsEwI2xvbD8wbn", name: "Fighting Lady Yellow", hex: "#f7dea2", type: "glossy", group: "reds-oranges-yellows", alexSealColorNo: "1164", index: 73 },
  { id: "tPUnKavx5Sr07hFHj3C7", name: "Federal Yellow", hex: "#fb9e00", type: "glossy", group: "reds-oranges-yellows", alexSealColorNo: "1232", index: 74 },
  { id: "BSfIKqInT0yHy7oG86AO", name: "Mellow Yellow", hex: "#f2e9ce", type: "glossy", group: "reds-oranges-yellows", alexSealColorNo: "1237", index: 75 },
